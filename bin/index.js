...
program
    ...
    .option('-dc, --delete-conversion', 'Delete all converted frames, default true')
    .option('-fn, --filename <name>', 'Name of output file, defaults to Pattern name')
    .requiredOption('-p, --pattern <pattern>', 'File Sequence pattern (e.g. "ObjectName_"')
    .alias('m')
